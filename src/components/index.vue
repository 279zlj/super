      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 container-fluid">
        <div class="row blockone">
          ...
          <div class="col-lg-5 col-md-12 col-sm-5 col-xs-5 ">
            <div class="row">
              <div class="fontone col-lg-12 col-md-6 col-sm-12 col-xs-12"><span class="titlecolor">{{$t('message.Question-card')}}：</span><a
                style="font-size: 2em;padding: .5em;color: white;cursor: pointer" class="dropdown-toggle"
                data-toggle="dropdown">{{$store.state.net.error}}</a>个
              ...
              <div style="margin-left: -1px">
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                  <p class="fonttwo "><span class="titlecolor">{{$t('message.link-number')}}：</span>{{$store.state.net.net_socket_link_nall}}
                  </p>
                </div>
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                  <p class="fonttwo "><span class="titlecolor">{{$t('message.Receive-Discard-Packets')}}：</span>{{$store.state.net.net_drop_in_all}}
                  </p>
                </div>
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                  <p class="fonttwo "><span class="titlecolor">{{$t('message.Send-Discard-Packets')}}：</span>{{$store.state.net.net_drop_out_all}}
                  </p>
                </div>
                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                  <p class="fonttwo "><span class="titlecolor">{{$t('message.Best-Match')}}：</span>{{$store.state.mode}}
                  </p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <p class="fonttwo "><span class="titlecolor">{{$t('message.Bandwidth')}}：</span>{{$store.state.net.bandwidth}}Mbps/s
                  </p>
                </div>
        ...
        <div class="row blockthree">
          ...
          <div class="col-lg-7 col-md-11 col-sm-7 col-xs-12 " id="yl">
            <div class="row blockfour">
              <p style="line-height: 2em;">{{$t('message.Memory')}}<span style="margin-left: 1em;"><span
                class="titlecolor">{{$t('message.Total-memory')}}：</span>{{$store.state.memory.total}}</span></p>
              <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 memory">
                  <div><p class="titlecolor">{{$t('message.Shared-memory')}}：</p>
                    <p>{{$store.state.memory.share}}</p></div>
                  <div><p class="titlecolor">cache：</p>
                    <p>{{$store.state.memory.cache}}</p></div>
              ...
              <div class="row memory">
                <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6"><p class="titlecolor">
                  {{$t('message.Swap-memory')}}：</p>
                  <p>{{$store.state.memory.totalSwap}}</p></div>
                <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6"><p class="titlecolor">{{$t('message.Swap-used')}}：</p>
                  <p>{{$store.state.memory.usedSwap}}</p></div>
              </div>
            </div>
          </div>
          <div class="col-lg-7 col-md-11 col-sm-7 col-xs-12 ">
            <div class="row blockfive">
              <div class="blockbottom">
                ...
                <div class="row size">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 titlecolor"
                       style="text-align: right;line-height: 2em;">{{$t('message.Used')}}：
                  </div>
              ...
              <div class="row">
                ...
                <div class="container-fluid" style="width: 90%;">
                  <table class="table-condensed table-responsive table size">
                    ...
                    <tr style="font-size: smaller" class="titlecolor">
                      <td>HOST</td>
                      <td>%CPU</td>
                    </tr>
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-7 col-md-12 col-sm-7 col-xs-12 " style="margin-top: 6em" id="ejz">
          <div class="row blockfour">
            ...
            <div class="row memory">
              <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6"><p class="titlecolor">{{$t('message.Swap-memory')}}：</p>
                <p>{{$store.state.memory.totalSwap}}</p></div>
              <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6"><p class="titlecolor">{{$t('message.Swap-used')}}：</p>
                <p>{{$store.state.memory.usedSwap}}</p></div>
            </div>
        ...
        <div id="log" class="logprint">
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 print">
            ...
            <div class="row">
              ...
              <div v-for="p in $store.state.ceph.pools">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><span
                  class="titlecolor">{{$t('message.Name')}}：</span>{{p.name}}
                </div>
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12"><span
                  class="titlecolor">{{$t('message.Status')}}：</span><span
                  :class="{'wanning':p.stats=='warn','ok':p.stats=='ok','error':p.stats=='error'}">{{p.stats}}</span>
                </div>
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12"><span class="titlecolor">{{$t('message.Percent-used')}}：</span>{{p.percent_used}}%
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                     style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis"><span class="titlecolor">{{$t('message.Max-available')}}：</span>{{p.max_avail}}
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12"><span class="titlecolor">{{$t('message.Activate-node')}}：</span><span>{{ activate_node}}</span>
              </div>
              <p class="col-lg-12"><span class="titlecolor">{{$t('message.Standby-node')}}：</span><span
                v-for="r in standby_node">{{r}}   </span></p>
            </div>
            <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 print">
            ...
            <div v-for="q in $store.state.ceph.osds">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="border-bottom: 1px solid #392C48"><span
                class="titlecolor">{{$t('message.Name')}}：</span>{{q.name}}
              </div>
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border-bottom: 1px solid #392C48"><span
                class="titlecolor">{{$t('message.Status')}}：</span><span
                :class="{'wanning':q.stats=='warn','ok':q.stats=='ok','error':q.stats=='error'}">{{q.stats}}</span>
              </div>
              <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="border-bottom: 1px solid #392C48"><span
                class="titlecolor">{{$t('message.Max-available')}}：</span>{{q.kb_avail}}
              </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 print">
            ...
            <p><span class="titlecolor">{{$t('message.Status')}}：</span><span
              :class="{'wanning':$store.state.rqlite_info.stats=='warn','ok':$store.state.rqlite_info.stats=='ok','error':$store.state.rqlite_info.stats=='error'}">{{$store.state.rqlite_info.stats}}</span>
            </p>
            <p style="font-size: medium">{{$t('message.Message-Process')}}</p>
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><span class="titlecolor">{{$t('message.Nodes')}}：</span>{{$store.state.redis.nodes}}
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><span class="titlecolor">{{$t('message.Used')}}：</span>{{$store.state.redis.used}}
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><span class="titlecolor">{{$t('message.Status')}}：</span><span
                :class="{'wanning':$store.state.redis.stats=='warn','ok':$store.state.redis.stats=='ok','error':$store.state.redis.stats=='error'}">{{$store.state.redis.stats}}</span>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.timer()
      // this.dosome()
      // console.log(this.$store.state.cpu_fans,'1111111111111111111111111111111111111111111111111111111')

      // console.log(this.$store.state.cputem[0],'111111111111111111111111111111111111111111111111111111111')
    },
    ...
    methods: {
      dosome(disks) {
        // console.log(disks, '333333333333333333333333333')
        for (let i = 0; i < disks.length; i++) {

          this.str = 'CPU温度：' + disks[i].cpu_temp
          this.staticall.push(this.str)
          // console.log(this.staticall.cpu_temp,'11111111111111111111111111111111111111111')
          this.strt = '风扇转速：' + disks[i].cpu_fans
          // console.log(JSON.stringify(this.staticall))
          this.ssfan.push(this.strt)
          // console.log(this.sscard,'11111111111111111111111111111111111111111')

          // console.log(this.$store.state.cputem)
        }
        // this.$store.commit('threemodels',{cpu_temp:this.staticall,cpu_fans:this.ssfan})
      ...
      websocketonmessage(e) {
        ...
        this.$store.commit('lindraw', {
          iwrite: data.message.data.iops[0],
          iread: data.message.data.iops[1],
          mwrite: data.message.data.mbps[0],
          mread: data.message.data.mbps[1],
          delaytime: data.message.data.delay,
          ti: data.message.data.time,
          health: data.message.data.health,
          ceph: data.message.data.ceph,
          rqlite_info: data.message.data.rqlite_info,
          redis: data.message.data.redis,
          disks: data.message.data.disks
        })
        this.staticall.splice(0)
        this.ssfan.splice(0)
        ...
        this.lindecharttwo(this.$store.state.ti, this.$store.state.mwrite, this.$store.state.mread)
        this.linechartthree(this.$store.state.ti, this.$store.state.delaytime)
        this.dosome(this.$store.state.disks)
      },
      websocketsend(Data) {
        console.log(Data)
      },
      ...
      getall() {                         /*获取首页信息*/
        ...
        _this.$axios.get(this.allurl).then(function (res) {
          ...
          _this.$store.commit('indexmsg', {
            net: res.data.net,
            memory: res.data.memory,
            icpu: res.data.cpu,
            swap_io: res.data.swap_io,
            mode: _this.mode,
            pool_use: res.data.net.speed,
            cpulist: res.data.cpu.detail,
            diskips: _this.diskips,
            diskops: _this.diskops,
            idisk: res.data.disk_io,
            rtime: _this.read_time,
            wtime: _this.write_time,
            btime: _this.busy_time
          })
